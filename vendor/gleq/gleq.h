...
inline Queue gleq_queue;

inline char* gleq_strdup(const char* string)
{
...
inline GLEQevent* gleq_new_event(void)
{
...
inline void gleq_window_pos_callback(GLFWwindow* window, int x, int y)
{
...
inline void gleq_window_size_callback(GLFWwindow* window, int width, int height)
{
    GLEQevent* event = gleq_new_event();
...
inline void gleq_window_close_callback(GLFWwindow* window)
{
    GLEQevent* event = gleq_new_event();
...
inline void gleq_window_refresh_callback(GLFWwindow* window)
{
    GLEQevent* event = gleq_new_event();
...
inline void gleq_window_focus_callback(GLFWwindow* window, int focused)
{
    GLEQevent* event = gleq_new_event();
    event->window = window;
...
inline void gleq_window_iconify_callback(GLFWwindow* window, int iconified)
{
    GLEQevent* event = gleq_new_event();
    event->window = window;
...
inline void gleq_framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
    GLEQevent* event = gleq_new_event();
...
inline void gleq_mouse_button_callback(GLFWwindow* window, int button, int action, int mods)
{
    GLEQevent* event = gleq_new_event();
    event->window = window;
...
inline void gleq_cursor_pos_callback(GLFWwindow* window, double x, double y)
{
    GLEQevent* event = gleq_new_event();
...
inline void gleq_cursor_enter_callback(GLFWwindow* window, int entered)
{
    GLEQevent* event = gleq_new_event();
    event->window = window;
...
inline void gleq_scroll_callback(GLFWwindow* window, double x, double y)
{
    GLEQevent* event = gleq_new_event();
...
inline void gleq_key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    GLEQevent* event = gleq_new_event();
    event->window = window;
...
inline void gleq_char_callback(GLFWwindow* window, unsigned int codepoint)
{
    GLEQevent* event = gleq_new_event();
...
inline void gleq_monitor_callback(GLFWmonitor* monitor, int action)
{
    GLEQevent* event = gleq_new_event();
...
#if GLFW_VERSION_MINOR >= 1
inline void gleq_file_drop_callback(GLFWwindow* window, int count, const char** paths)
{
    GLEQevent* event = gleq_new_event();
...
#if GLFW_VERSION_MINOR >= 2
inline void gleq_joystick_callback(int jid, int action)
{
    GLEQevent* event = gleq_new_event();
    event->joystick = jid;
...
#if GLFW_VERSION_MINOR >= 3
inline void gleq_window_maximize_callback(GLFWwindow* window, int maximized)
{
    GLEQevent* event = gleq_new_event();
    event->window = window;
...
inline void gleq_window_content_scale_callback(GLFWwindow* window, float xscale, float yscale)
{
    GLEQevent* event = gleq_new_event();
    event->window = window;
